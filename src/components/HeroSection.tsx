      ...
      <div className="container mx-auto px-4 sm:px-6 py-12 md:py-24">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          <div className="order-2 md:order-1 animate-fade-in">
            <h2 className="text-lg font-medium text-red-600">Hello, I'm</h2>
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mt-2 leading-tight">
              Joseph <span className="text-gradient-red">Vineeth Reddy</span>
            </h1>
            ...
            <div className="flex flex-wrap gap-3 mt-6">
              <a href="https://github.com/josephkatakam" target="_blank" rel="noopener noreferrer">
                <Button variant="outline" size="icon" className="rounded-full gradient-border-red">
          ...
          <div className="order-1 md:order-2 flex justify-center items-center">
            <div className="relative mx-auto">
              ...
              <div className="absolute -bottom-4 -right-4 w-24 h-24 md:w-32 md:h-32 bg-gradient-red rounded-full opacity-30 blur-xl"></div>
              <div className="absolute -top-4 -left-4 w-24 h-24 md:w-32 md:h-32 bg-gradient-red rounded-full opacity-30 blur-xl"></div>
            </div>
          </div>
        </div>
      </div>
